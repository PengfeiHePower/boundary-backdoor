...
def get_poison_transform(poison_type, dataset_name, target_class, source_class=1, cover_classes=[5,7],
    ...
    if dataset_name in ['gtsrb','cifar10', 'cifar100', 'synthesis-cifar10', 'cifar100']:
        img_size = 32
    ...
    if dataset_name == 'cifar10':
        ...
        denormalizer = transforms.Compose([
            transforms.Normalize([-0.5070 / 0.2673, -0.4865 / 0.2564, -0.4409 / 0.2761],
                                    [1 / 0.2673, 1 / 0.2564, 1 / 0.2761])
        ])
